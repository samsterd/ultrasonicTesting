...
status["trigger"] = ps.ps2000_set_trigger(chandle, 0, 64, 0, 2750, 10)
...
# Track time to set up pico parameters
setUpTime = time()
print(openTime - setUpTime)
...
# End of data collection time
collectionTime = time()
print(setUpTime - collectionTime)
...
# Print total time to setup and run
print(startTime - collectionTime)
